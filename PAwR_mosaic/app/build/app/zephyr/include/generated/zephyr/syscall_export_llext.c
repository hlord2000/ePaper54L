...
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtio_cqe_get_mempool_buffer;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtio_release_buffer;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtio_sqe_cancel;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtio_sqe_copy_in_get_handles;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtio_cqe_copy_out;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtio_submit;
