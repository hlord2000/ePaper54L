...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_VDB_SIZE, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SOLOMON_SSD1680_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_SPIM21, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_TWIM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_TWIM30, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_UARTE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_UARTE20, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_UARTE_CONFIG_SKIP_GPIO_CONFIG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_UARTE_CONFIG_SKIP_PSEL_CONFIG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_FLUSH_THREAD_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_FLUSH_THREAD_PRIO, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF54L15ESL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF54L15ESL_NRF54L15_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_SPIM21, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SSD16XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_ASYNC_RX_HELPER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_ASYNC_TO_INT_DRIVEN_API, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_ASYNC_TO_INT_DRIVEN_RX_TIMEOUT, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_20_TX_CACHE_SIZE, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_20_RX_CACHE_SIZE, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_20_A2I_RX_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_20_A2I_RX_BUF_COUNT, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_SHELL, 1);
