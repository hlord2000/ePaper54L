...
.. figure:: img/nrf54l15esl_nrf54l15.webp
     :align: center
     :alt: nRF54L15 DK
...
The ``nrf54l15esl/nrf54l15/cpuapp`` board target configuration supports the following
hardware features:
...
Applications for the ``nrf54l15esl/nrf54l15/cpuapp`` board target can be
built, flashed, and debugged in the usual way. See
:ref:`build_an_application` and :ref:`application_run` for more details on
building and running.

Applications for the ``nrf54l15esl/nrf54l15/cpuflpr`` board target need
...
.. zephyr-app-commands::
   ...
   :board: nrf54l15esl/nrf54l15/cpuapp
   :goals: build flash
